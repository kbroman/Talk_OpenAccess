...
\begin{frame}{All I care about}

\bi
\itemsep12pt
\item Getting the papers I want to read
\item People reading my papers
\ei
\end{frame}
...
\item {\color<3>{hilight} \color<4>{gray} Writing}
\item {\color<3>{hilight} \color<4>{gray} Peer review, editorial oversight}
\item {\color<3>{gray} \color<4>{hilight} Managing manuscripts}
\item {\color<3>{gray} \color<4>{hilight} Copy editing, typesetting}
\item {\color<3>{gray} \color<4>{hilight} Distribution}
\item<2-> {\color<2>{vhilight} \color<3>{gray} \color<4>{hilight} Profit}
\ei
\end{frame}
...
\bi
\itemsep6pt
\item {\color<3>{gray} Peer review}
\item {\color<3>{gray} Predatory publishing}
