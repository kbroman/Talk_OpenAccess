...
\note{I'll begin with an illustration of what I mean by
  access. \\[12pt]
  The other day I was reading a manuscript and saw a
...
\note{If I paste the article title into Google Scholar, I immediately
  find the paper and can go directly to the journal. \\[12pt]
  But they charge \$40 for a 7 page paper!}
\end{frame}
...
\note{I went back to some of my early papers, and found these
  outrageous prices.\\[12pt]
  \$18 for a 2-page paper? \\[12pt]
  I understand that the publishing industry has a long history of
  screwy pricing, but you'd have to be either \emph{desperate\/} or
  \emph{stupid\/} to pay these prices. \\[12pt]
