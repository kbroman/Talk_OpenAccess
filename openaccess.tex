...
\bigskip
\begin{center}
\includegraphics[width=0.7\textwidth, keepaspectratio]{Images/img04.jpg}

\onslide<2-4>{
  \vspace*{-0.55\textheight}
  \hspace*{0.10\textwidth}
  \includegraphics[width=0.7\textwidth, keepaspectratio]{Images/img05.jpg}
}

\onslide<3-4>{
  \vspace*{-0.55\textheight}
  \hspace*{0.20\textwidth}
  \includegraphics[width=0.7\textwidth, keepaspectratio]{Images/img06.jpg}
}

\onslide<4>{
  \vspace*{-0.35\textheight}
  \hspace*{0.30\textwidth}
  \includegraphics[width=0.7\textwidth]{Images/img03.jpg}
}
...
{ \footnotesize \color{subtitle}
Library catalog\dots
}

\bigskip
\begin{center}
\includegraphics[width=0.7\textwidth]{Images/img07.jpg}

\onslide<2-4>{
  \vspace*{-0.45\textheight}
  \hspace*{0.10\textwidth}
  \includegraphics[width=0.7\textwidth]{Images/img08.jpg}
}

\onslide<3-4>{
  \vspace*{-0.55\textheight}
  \hspace*{0.20\textwidth}
  \includegraphics[width=0.7\textwidth]{Images/img09.jpg}
}
...
\onslide<3>{
  ...
  \includegraphics[height=0.85\textheight]{Images/img14.png}
}
\end{center}
